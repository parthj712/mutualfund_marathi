export const DEBT_FUND_ADVANTAGES = [
    {
        number: "1",
        ...
        subTextColor: "black",
        subText:
            "Debt Fund प्रामुख्याने सरकारी बाँड्स, कॉर्पोरेट बाँड्स, ट्रेझरी बिल्स यामध्ये गुंतवणूक करतात. यामुळे दीर्घकाळात बँक FD पेक्षा 0.5% ते 2% पर्यंत जास्त परतावा मिळण्याची शक्यता असते, विशेषतः करपश्चात (Tax-adjusted) परतावा पाहिला तर.",
    },
    {
        number: "2",
        ...
        subText: (
            <div>
                ...
                <ul style={{ paddingLeft: "12px", marginTop: "2px" }}>
                    ...
                    <li>• Indexation चा फायदा मिळतो</li>
