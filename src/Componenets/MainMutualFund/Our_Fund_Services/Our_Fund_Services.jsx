        ...
        <div>
            ...
            <Box display={"flex"} flexDirection={"column"} p={isMobile ? 4 : 10} gap={6}>
                ...
                <Typography fontSize={isMobile ? "16px" : "18px"}>
                    ...
                    • आमच्या वेबसाईटवर लॉगीन (https://shthakur.com) करूनही आपला पोर्टफोलिओ पाहू शकता. येथे आपण सारे आर्थिक व्यवहार ऑनलान करू शकता. तसेच तुमचे भविष्यातील सारी आर्थिक उद्दिष्टे साध्य करण्यासाठी तुमचे गोल सेट करू शकता आणि आर्थिक नियोजन तुमचे तुम्ही करू शकता. याच प्रमाणे भराव्या लागणाऱ्या शॉर्ट टर्म व लॉंग टर्म कर आकारणी पाहू शकता.<br/>
