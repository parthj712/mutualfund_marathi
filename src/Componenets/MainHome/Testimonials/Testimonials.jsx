...
export default function Testimonials() {
  ...
  const fetchTestimonials = async () => {
    try {
      ...
      console.log("API DATA:", res.data.testimonials);
  ...
  return (
    <Box
      ...
      alignItems={"center"}
      className="w-full bg-[#00487b] text-white py-16 px-4"
    >
      <Box className="max-w-6xl mx-auto flex flex-col items-center  gap-4">
        {/* TOP HEADING */}
        <GradientUnderlineHeading
          text="आमचे गुंतवणूकदार काय म्हणतात"
          size={"24px"}
        />

        {/* SUBHEADING */}
        <Typography fontSize={isMobile ? "18px" : "20px"} py={4}>
          आमच्या विश्वासार्ह सेवे, कौशल्यामुळे आणि व्यावसायिक सेवे मुळे ग्राहक
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-10 mt-6">
          ...
          >
            ...
            <Typography
              textAlign={"left"}
              fontSize={isMobile ? "26px" : isTablet ? "32px" : "52px"}
            >
              ...
              >
                <Box display="flex" flexDirection="column" gap={4}>
                  <Typography
                    ...
                    lineHeight={1.8}
                  >
                    {testimonials[currentIndex]?.feedbackText || "—"}
                  </Typography>
