...
const team = [
  ...
  {
    name: "श्री. सुजय ठाकूर",
    desc: `बीकॉम. आणि एमबीए (फायनान्स) यांनी १० वर्षे ऍक्सिस बँक व कोटक बँकेत व्यवस्थापकीय पदावर काम केल्यानंतर ३ ऑक्टोबर २०१८ रोजी  ठाकूर फायनान्शिअल सर्व्हिसेस मध्ये सामील झालेले आहेत. श्री ठाकूर फिनसर्व्ह प्रायव्हेट लिमिटेड ते भागधारक (Shareholder) असून Managing Director  आहेत.`,
    image: "/MainLogo.png",
    bgColor: "#E9F7FF",
  ...
  {
    name: "श्री. प्रथमेश उदय शेंडे",
    desc: `बँकिंग आणि म्युच्युअल फंड क्षेत्रात १० वर्षांहून अधिक अनुभव असलेले संचालक. ते पुणे विद्यापीठातून वाणिज्य पदवीधर आहेत आणि त्यांनी जोखीम व्यवस्थापन (म्युच्युअल फंड आणि विमा) मध्ये IPGDM चा अभ्यास केला आहे. श्री ठाकूर फिनसर्व्ह प्रायव्हेट लिमिटेड ते भागधारक (Shareholder) असून Director  आहेत.`,
    image: "/MainLogo.png",
    bgColor: "#FFF3E6",
      ...
      <Box display={"flex"} flexDirection={"column"} gap={6} py={4}>
        ...
        <Box display={"flex"} flexDirection={"column"} p={isMobile ? 4 : 10} gap={14}>
          ...
          <Box display={"flex"} flexDirection={"column"} gap={isMobile ? 4 : 6}>
            <GradientHeading text="श्री ठाकूर फिनसर्व्ह प्रायव्हेट लिमिटेड "  align={isMobile ? "left" : 'center'} />
